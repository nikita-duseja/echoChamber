...
categories = ['high_left','mid_left','low_left','high_right','mid_right','low_right']

data_train              = Bunch()
data_train.data         = raw_X_train
data_train.target_names = ['high_left','mid_left','low_left','high_right','mid_right','low_right']
